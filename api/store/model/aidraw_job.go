...
type AiDrawJob struct {
	...
	Mode      string    `gorm:"column:mode;type:varchar(20);not null;default:text_to_image;comment:生成模式" json:"mode"`
...
func (m *AiDrawJob) TableName() string {
	return "geekai_aidraw_jobs"
}
