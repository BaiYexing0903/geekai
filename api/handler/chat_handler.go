...
func NewChatHandler(app *core.AppServer, db *gorm.DB, redis *redis.Client, manager *oss.UploaderManager, userService *service.UserService, moderationManager *moderation.ServiceManager) *ChatHandler {
	return &ChatHandler{
